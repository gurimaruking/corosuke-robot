...
| **超音波カッター**(または代替物) | 3Dプリントパーツの加工に便利。プラスチックが溶ければ良いので熱した金属針でも可 | Aliexpress |
| **3D Printer** | パーツの印刷に必要！(今回は **Bambu Lab A1**。パーツは18cm以内のため **A1 miniでもぎりぎり印刷できるはず**) | — |
| **両面テープ** | パーツの接着に便利 | — |
| **紐** | 手を動かすのに必要 | — |
| **結束バンド** | ロープアームの調整に必要 | [ダイソー](https://jp.daisonet.com/products/4550480088891) |
| **はんだごて** | 少しのはんだ付け(電源ボタンやアンプ端子など) | — |
| **ブレッドボード**(小型) | ESP32-S3まわりの配線 | — |
| **ジャンパワイヤ**(オス-オス/オス-メス) | 各部品の接続 | — |
