...
| M5 | 7/14– | **Stage 3 — Launch** | demo video; benchmark; Stage 3 showcase | 🔄 [STAGE3.md](STAGE3.md) + README Quick Start + benchmarks + ROS 2 graph + failure-recovery docs all done; **demo video done ([youtu.be/YLB5ZIfMwXY](https://youtu.be/YLB5ZIfMwXY)); showcase PR pending** |
